...
gdjs.GameCode.GDCactusObstacleObjects3_1final = [];

gdjs.GameCode.GDDinoObjects3_1final = [];

gdjs.GameCode.GDIslandObstacleObjects3_1final = [];

gdjs.GameCode.GDMeteorObjects3_1final = [];
...
gdjs.GameCode.GDCactusObstacleObjects7= [];
...
gdjs.GameCode.GDIslandObstacleObjects7= [];
...
gdjs.GameCode.GDScoreTextObjects7= [];
...
gdjs.GameCode.GDTutorialSpriteObjects7= [];
...
gdjs.GameCode.GDBonusParticleObjects7= [];
...
gdjs.GameCode.GDTutorialTouchscreenJumpObjects7= [];
...
gdjs.GameCode.GDTutorialTouchscreenDuckObjects7= [];
...
gdjs.GameCode.GDJumpButtonObjects7= [];
...
gdjs.GameCode.GDDuckButtonObjects7= [];
...
gdjs.GameCode.GDPlatformObjects7= [];
...
gdjs.GameCode.GDBackgroundObjects7= [];
...
gdjs.GameCode.GDDustParticlesObjects7= [];
gdjs.GameCode.GDMeteorObjects1= [];
gdjs.GameCode.GDMeteorObjects2= [];
gdjs.GameCode.GDMeteorObjects3= [];
gdjs.GameCode.GDMeteorObjects4= [];
gdjs.GameCode.GDMeteorObjects5= [];
gdjs.GameCode.GDMeteorObjects6= [];
gdjs.GameCode.GDMeteorObjects7= [];
...
gdjs.GameCode.GDLivesTextObjects7= [];
gdjs.GameCode.GDbroken_9595heartObjects1= [];
gdjs.GameCode.GDbroken_9595heartObjects2= [];
gdjs.GameCode.GDbroken_9595heartObjects3= [];
gdjs.GameCode.GDbroken_9595heartObjects4= [];
gdjs.GameCode.GDbroken_9595heartObjects5= [];
gdjs.GameCode.GDbroken_9595heartObjects6= [];
gdjs.GameCode.GDbroken_9595heartObjects7= [];
...
gdjs.GameCode.GDBonusObjectObjects7= [];
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13146148);
}
if (isConditionTrue_0) {
...
{runtimeScene.getScene().getVariables().getFromIndex(8).setNumber(300);
}
{runtimeScene.getScene().getVariables().getFromIndex(9).setNumber(0.4);
}
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "meteor_spawn");
}
{runtimeScene.getScene().getVariables().getFromIndex(10).setNumber(2);
}
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "damage_cooldown");
}
...
};gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDMeteorObjects4Objects = Hashtable.newFrom({"Meteor": gdjs.GameCode.GDMeteorObjects4});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = (runtimeScene.getScene().getVariables().getFromIndex(7).getAsNumber() < gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(9)));
}
if (isConditionTrue_0) {
{runtimeScene.getScene().getVariables().getFromIndex(7).setNumber(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(7)));
}
}
...
gdjs.copyArray(gdjs.GameCode.GDDinoObjects5, gdjs.GameCode.GDDinoObjects6);


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDDinoObjects6.length;i<l;++i) {
    if ( gdjs.GameCode.GDDinoObjects6[i].getBehavior("Animation").hasAnimationEnded() ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDDinoObjects6[k] = gdjs.GameCode.GDDinoObjects6[i];
        ++k;
    }
}
gdjs.GameCode.GDDinoObjects6.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDDinoObjects6 */
{for(var i = 0, len = gdjs.GameCode.GDDinoObjects6.length ;i < len;++i) {
    gdjs.GameCode.GDDinoObjects6[i].getBehavior("Animation").setAnimationName("Run");
}
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13046844);
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDDinoObjects5 */
gdjs.copyArray(runtimeScene.getObjects("DustParticles"), gdjs.GameCode.GDDustParticlesObjects5);
{for(var i = 0, len = gdjs.GameCode.GDDustParticlesObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDDustParticlesObjects5[i].setPosition((( gdjs.GameCode.GDDinoObjects5.length === 0 ) ? 0 :gdjs.GameCode.GDDinoObjects5[0].getPointX("DustProjection")),(( gdjs.GameCode.GDDinoObjects5.length === 0 ) ? 0 :gdjs.GameCode.GDDinoObjects5[0].getPointY("DustProjection")));
}
}
{for(var i = 0, len = gdjs.GameCode.GDDustParticlesObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDDustParticlesObjects5[i].startEmission();
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("Dino"), gdjs.GameCode.GDDinoObjects6);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDDinoObjects6.length;i<l;++i) {
    if ( gdjs.GameCode.GDDinoObjects6[i].getBehavior("PlatformerObject").isJumping() ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDDinoObjects6[k] = gdjs.GameCode.GDDinoObjects6[i];
        ++k;
    }
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13048860);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDDinoObjects6 */
...
{for(var i = 0, len = gdjs.GameCode.GDDinoObjects6.length ;i < len;++i) {
    gdjs.GameCode.GDDinoObjects6[i].getBehavior("Animation").setAnimationName("Jump");
}
}
}
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDDinoObjects5.length;i<l;++i) {
    if ( gdjs.GameCode.GDDinoObjects5[i].getBehavior("Animation").getAnimationName() == "Duck" ) {
        isConditionTrue_0 = true;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13049380);
}
}
if (isConditionTrue_0) {
...
};gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDJumpButtonObjects5Objects = Hashtable.newFrom({"JumpButton": gdjs.GameCode.GDJumpButtonObjects5});
gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDDuckButtonObjects4Objects = Hashtable.newFrom({"DuckButton": gdjs.GameCode.GDDuckButtonObjects4});
gdjs.GameCode.eventsList7 = function(runtimeScene) {

{

gdjs.copyArray(runtimeScene.getObjects("JumpButton"), gdjs.GameCode.GDJumpButtonObjects5);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDJumpButtonObjects5Objects, runtimeScene, true, false);
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Dino"), gdjs.GameCode.GDDinoObjects5);
{for(var i = 0, len = gdjs.GameCode.GDDinoObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDDinoObjects5[i].getBehavior("PlatformerObject").simulateJumpKey();
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("DuckButton"), gdjs.GameCode.GDDuckButtonObjects4);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDDuckButtonObjects4Objects, runtimeScene, true, false);
if (isConditionTrue_0) {
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDDinoObjects5.length;i<l;++i) {
    if ( gdjs.GameCode.GDDinoObjects5[i].getBehavior("PlatformerObject").isOnFloor() ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDDinoObjects5[k] = gdjs.GameCode.GDDinoObjects5[i];
        ++k;
    }
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13052316);
}
}
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("DustParticles"), gdjs.GameCode.GDDustParticlesObjects5);
{for(var i = 0, len = gdjs.GameCode.GDDinoObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDDinoObjects5[i].getBehavior("Animation").setAnimationName("Duck");
}
}
{for(var i = 0, len = gdjs.GameCode.GDDustParticlesObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDDustParticlesObjects5[i].setX((( gdjs.GameCode.GDDinoObjects5.length === 0 ) ? 0 :gdjs.GameCode.GDDinoObjects5[0].getAABBRight()));
}
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13053364);
}
}
if (isConditionTrue_0) {
...
gdjs.copyArray(runtimeScene.getObjects("Dino"), gdjs.GameCode.GDDinoObjects5);
{for(var i = 0, len = gdjs.GameCode.GDDinoObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDDinoObjects5[i].setX(gdjs.GameCode.GDDinoObjects5[i].getVariables().getFromIndex(0).getAsNumber());
}
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13047852);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("DustParticles"), gdjs.GameCode.GDDustParticlesObjects5);
{for(var i = 0, len = gdjs.GameCode.GDDustParticlesObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDDustParticlesObjects5[i].stopEmission();
}
}
}
...
};gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDDinoObjects5Objects = Hashtable.newFrom({"Dino": gdjs.GameCode.GDDinoObjects5});
...
gdjs.copyArray(runtimeScene.getObjects("BonusObject"), gdjs.GameCode.GDBonusObjectObjects5);
gdjs.copyArray(runtimeScene.getObjects("Dino"), gdjs.GameCode.GDDinoObjects5);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDDinoObjects5Objects, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBonusObjectObjects5Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("BonusParticle"), gdjs.GameCode.GDBonusParticleObjects5);
/* Reuse gdjs.GameCode.GDDinoObjects5 */
/* Reuse gdjs.GameCode.GDBonusObjectObjects5 */
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBonusObjectObjects5Objects, (( gdjs.GameCode.GDDinoObjects5.length === 0 ) ? 0 :gdjs.GameCode.GDDinoObjects5[0].getCenterXInScene()), (( gdjs.GameCode.GDDinoObjects5.length === 0 ) ? 0 :gdjs.GameCode.GDDinoObjects5[0].getCenterYInScene()), "");
}
{for(var i = 0, len = gdjs.GameCode.GDBonusParticleObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDBonusParticleObjects5[i].setAngle(-(90));
}
}
{for(var i = 0, len = gdjs.GameCode.GDBonusObjectObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDBonusObjectObjects5[i].deleteFromScene(runtimeScene);
}
}
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("BonusParticle"), gdjs.GameCode.GDBonusParticleObjects4);
gdjs.copyArray(runtimeScene.getObjects("Dino"), gdjs.GameCode.GDDinoObjects4);
{for(var i = 0, len = gdjs.GameCode.GDBonusParticleObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDBonusParticleObjects4[i].setCenterPositionInScene((( gdjs.GameCode.GDDinoObjects4.length === 0 ) ? 0 :gdjs.GameCode.GDDinoObjects4[0].getCenterXInScene()),(( gdjs.GameCode.GDDinoObjects4.length === 0 ) ? 0 :gdjs.GameCode.GDDinoObjects4[0].getCenterYInScene()));
}
}
}
...
gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDIslandObstacleObjects5Objects = Hashtable.newFrom({"IslandObstacle": gdjs.GameCode.GDIslandObstacleObjects5});
gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBonusObjectObjects6Objects = Hashtable.newFrom({"BonusObject": gdjs.GameCode.GDBonusObjectObjects6});
gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBonusObjectObjects5Objects = Hashtable.newFrom({"BonusObject": gdjs.GameCode.GDBonusObjectObjects5});
gdjs.GameCode.eventsList11 = function(runtimeScene) {

{

gdjs.copyArray(gdjs.GameCode.GDIslandObstacleObjects5, gdjs.GameCode.GDIslandObstacleObjects6);


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDIslandObstacleObjects6.length;i<l;++i) {
    if ( gdjs.GameCode.GDIslandObstacleObjects6[i].getVariableNumber(gdjs.GameCode.GDIslandObstacleObjects6[i].getVariables().getFromIndex(0)) == 0 ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDIslandObstacleObjects6[k] = gdjs.GameCode.GDIslandObstacleObjects6[i];
        ++k;
    }
}
gdjs.GameCode.GDIslandObstacleObjects6.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDIslandObstacleObjects6 */
gdjs.GameCode.GDBonusObjectObjects6.length = 0;

{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBonusObjectObjects6Objects, (( gdjs.GameCode.GDIslandObstacleObjects6.length === 0 ) ? 0 :gdjs.GameCode.GDIslandObstacleObjects6[0].getPointX("RewardUp")), (( gdjs.GameCode.GDIslandObstacleObjects6.length === 0 ) ? 0 :gdjs.GameCode.GDIslandObstacleObjects6[0].getPointY("RewardUp")), "");
}
{for(var i = 0, len = gdjs.GameCode.GDBonusObjectObjects6.length ;i < len;++i) {
    gdjs.GameCode.GDBonusObjectObjects6[i].addPolarForce(180, runtimeScene.getScene().getVariables().getFromIndex(3).getAsNumber(), 1);
}
}
{for(var i = 0, len = gdjs.GameCode.GDBonusObjectObjects6.length ;i < len;++i) {
    gdjs.GameCode.GDBonusObjectObjects6[i].getBehavior("Scale").setScale(0.15);
}
}
}
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDIslandObstacleObjects5.length;i<l;++i) {
    if ( gdjs.GameCode.GDIslandObstacleObjects5[i].getVariableNumber(gdjs.GameCode.GDIslandObstacleObjects5[i].getVariables().getFromIndex(0)) == 1 ) {
        isConditionTrue_0 = true;
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBonusObjectObjects5Objects, (( gdjs.GameCode.GDIslandObstacleObjects5.length === 0 ) ? 0 :gdjs.GameCode.GDIslandObstacleObjects5[0].getPointX("RewardDown")), (( gdjs.GameCode.GDIslandObstacleObjects5.length === 0 ) ? 0 :gdjs.GameCode.GDIslandObstacleObjects5[0].getPointY("RewardDown")), "");
}
{for(var i = 0, len = gdjs.GameCode.GDBonusObjectObjects5.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.GameCode.GDBonusObjectObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDBonusObjectObjects5[i].getBehavior("Scale").setScale(0.15);
}
}
}
...
};gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDCactusObstacleObjects6Objects = Hashtable.newFrom({"CactusObstacle": gdjs.GameCode.GDCactusObstacleObjects6});
...
do {
gdjs.copyArray(runtimeScene.getObjects("Platform"), gdjs.GameCode.GDPlatformObjects6);
...
let isConditionTrue_0 = false;
if (true) {
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDCactusObstacleObjects6Objects, 100 + gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) + runtimeScene.getScene().getVariables().getFromIndex(6).getAsNumber() * 70, (( gdjs.GameCode.GDPlatformObjects6.length === 0 ) ? 0 :gdjs.GameCode.GDPlatformObjects6[0].getAABBTop()), "");
}
{for(var i = 0, len = gdjs.GameCode.GDCactusObstacleObjects6.length ;i < len;++i) {
    gdjs.GameCode.GDCactusObstacleObjects6[i].addPolarForce(180, runtimeScene.getScene().getVariables().getFromIndex(3).getAsNumber(), 1);
}
}
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDCactusObstacleObjects5Objects, gdjs.randomInRange(75, 125) + gdjs.evtTools.window.getGameResolutionWidth(runtimeScene), (( gdjs.GameCode.GDPlatformObjects5.length === 0 ) ? 0 :gdjs.GameCode.GDPlatformObjects5[0].getAABBTop()), "");
}
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDIslandObstacleObjects5Objects, gdjs.randomInRange(75, 125) + gdjs.evtTools.window.getGameResolutionWidth(runtimeScene), (( gdjs.GameCode.GDPlatformObjects5.length === 0 ) ? 0 :gdjs.GameCode.GDPlatformObjects5[0].getAABBTop()) - 64, "");
}
{for(var i = 0, len = gdjs.GameCode.GDIslandObstacleObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDIslandObstacleObjects5[i].returnVariable(gdjs.GameCode.GDIslandObstacleObjects5[i].getVariables().getFromIndex(0)).setNumber(gdjs.randomInRange(0, 2));
}
}
{for(var i = 0, len = gdjs.GameCode.GDIslandObstacleObjects5.length ;i < len;++i) {
    gdjs.GameCode.GDIslandObstacleObjects5[i].addPolarForce(180, runtimeScene.getScene().getVariables().getFromIndex(3).getAsNumber(), 1);
}
}
...
gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDbroken_95959595heartObjects3Objects = Hashtable.newFrom({"broken_heart": gdjs.GameCode.GDbroken_9595heartObjects3});
...
/* Reuse gdjs.GameCode.GDCactusObstacleObjects3 */
/* Reuse gdjs.GameCode.GDDinoObjects3 */
gdjs.copyArray(runtimeScene.getObjects("DustParticles"), gdjs.GameCode.GDDustParticlesObjects3);
/* Reuse gdjs.GameCode.GDIslandObstacleObjects3 */
{for(var i = 0, len = gdjs.GameCode.GDDinoObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDDinoObjects3[i].getBehavior("Animation").setAnimationName("Dead");
}
}
...
{for(var i = 0, len = gdjs.GameCode.GDDinoObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDDinoObjects3[i].getBehavior("PlatformerObject").abortJump();
}
}
...
{for(var i = 0, len = gdjs.GameCode.GDDustParticlesObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDDustParticlesObjects3[i].stopEmission();
}
}
}
...
gdjs.copyArray(gdjs.GameCode.GDMeteorObjects3, gdjs.GameCode.GDMeteorObjects4);


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDMeteorObjects4.length;i<l;++i) {
    if ( gdjs.GameCode.GDMeteorObjects4[i].getY() > gdjs.evtTools.window.getGameResolutionHeight(runtimeScene) + 100 ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDMeteorObjects4[k] = gdjs.GameCode.GDMeteorObjects4[i];
        ++k;
    }
}
gdjs.GameCode.GDMeteorObjects4.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDMeteorObjects4 */
{for(var i = 0, len = gdjs.GameCode.GDMeteorObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDMeteorObjects4[i].deleteFromScene(runtimeScene);
}
}
}
...
{
/* Reuse gdjs.GameCode.GDDinoObjects3 */
gdjs.GameCode.GDbroken_9595heartObjects3.length = 0;

{runtimeScene.getScene().getVariables().getFromIndex(10).sub(1);
}
{for(var i = 0, len = gdjs.GameCode.GDDinoObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDDinoObjects3[i].getBehavior("PlatformerObject").abortJump();
}
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDbroken_95959595heartObjects3Objects, 400, 50, "");
}
{for(var i = 0, len = gdjs.GameCode.GDbroken_9595heartObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDbroken_9595heartObjects3[i].getBehavior("Scale").setScale(gdjs.GameCode.GDbroken_9595heartObjects3[i].getBehavior("Scale").getScale() / (2));
}
}
{for(var i = 0, len = gdjs.GameCode.GDbroken_9595heartObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDbroken_9595heartObjects3[i].resetTimer("desaparecer");
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSecondsOrNaN(runtimeScene, "damage_cooldown") > 1.5;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{gdjs.GameCode.GDCactusObstacleObjects3_1final.length = 0;
gdjs.GameCode.GDDinoObjects3_1final.length = 0;
gdjs.GameCode.GDIslandObstacleObjects3_1final.length = 0;
gdjs.GameCode.GDMeteorObjects3_1final.length = 0;
let isConditionTrue_1 = false;
isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("CactusObstacle"), gdjs.GameCode.GDCactusObstacleObjects4);
gdjs.copyArray(runtimeScene.getObjects("Dino"), gdjs.GameCode.GDDinoObjects4);
isConditionTrue_1 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDDinoObjects4Objects, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDCactusObstacleObjects4Objects, false, runtimeScene, false);
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
    for (let j = 0, jLen = gdjs.GameCode.GDCactusObstacleObjects4.length; j < jLen ; ++j) {
        if ( gdjs.GameCode.GDCactusObstacleObjects3_1final.indexOf(gdjs.GameCode.GDCactusObstacleObjects4[j]) === -1 )
            gdjs.GameCode.GDCactusObstacleObjects3_1final.push(gdjs.GameCode.GDCactusObstacleObjects4[j]);
    }
    for (let j = 0, jLen = gdjs.GameCode.GDDinoObjects4.length; j < jLen ; ++j) {
        if ( gdjs.GameCode.GDDinoObjects3_1final.indexOf(gdjs.GameCode.GDDinoObjects4[j]) === -1 )
            gdjs.GameCode.GDDinoObjects3_1final.push(gdjs.GameCode.GDDinoObjects4[j]);
    }
}
}
{
gdjs.copyArray(runtimeScene.getObjects("Dino"), gdjs.GameCode.GDDinoObjects4);
gdjs.copyArray(runtimeScene.getObjects("Meteor"), gdjs.GameCode.GDMeteorObjects4);
isConditionTrue_1 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDDinoObjects4Objects, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDMeteorObjects4Objects, false, runtimeScene, false);
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
    for (let j = 0, jLen = gdjs.GameCode.GDDinoObjects4.length; j < jLen ; ++j) {
        if ( gdjs.GameCode.GDDinoObjects3_1final.indexOf(gdjs.GameCode.GDDinoObjects4[j]) === -1 )
    ...
    for (let j = 0, jLen = gdjs.GameCode.GDMeteorObjects4.length; j < jLen ; ++j) {
        if ( gdjs.GameCode.GDMeteorObjects3_1final.indexOf(gdjs.GameCode.GDMeteorObjects4[j]) === -1 )
            gdjs.GameCode.GDMeteorObjects3_1final.push(gdjs.GameCode.GDMeteorObjects4[j]);
    }
}
}
{
gdjs.copyArray(runtimeScene.getObjects("Dino"), gdjs.GameCode.GDDinoObjects4);
gdjs.copyArray(runtimeScene.getObjects("IslandObstacle"), gdjs.GameCode.GDIslandObstacleObjects4);
{let isConditionTrue_2 = false;
isConditionTrue_2 = false;
isConditionTrue_2 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDDinoObjects4Objects, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDIslandObstacleObjects4Objects, false, runtimeScene, true);
if (isConditionTrue_2) {
isConditionTrue_2 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDDinoObjects4.length;i<l;++i) {
    if ( gdjs.GameCode.GDDinoObjects4[i].getAABBBottom() > (( gdjs.GameCode.GDIslandObstacleObjects4.length === 0 ) ? 0 :gdjs.GameCode.GDIslandObstacleObjects4[0].getAABBCenterY()) ) {
...
if(isConditionTrue_1) {
    ...
    for (let j = 0, jLen = gdjs.GameCode.GDIslandObstacleObjects4.length; j < jLen ; ++j) {
        if ( gdjs.GameCode.GDIslandObstacleObjects3_1final.indexOf(gdjs.GameCode.GDIslandObstacleObjects4[j]) === -1 )
            gdjs.GameCode.GDIslandObstacleObjects3_1final.push(gdjs.GameCode.GDIslandObstacleObjects4[j]);
    }
}
}
{
gdjs.copyArray(gdjs.GameCode.GDCactusObstacleObjects3_1final, gdjs.GameCode.GDCactusObstacleObjects3);
gdjs.copyArray(gdjs.GameCode.GDDinoObjects3_1final, gdjs.GameCode.GDDinoObjects3);
gdjs.copyArray(gdjs.GameCode.GDIslandObstacleObjects3_1final, gdjs.GameCode.GDIslandObstacleObjects3);
gdjs.copyArray(gdjs.GameCode.GDMeteorObjects3_1final, gdjs.GameCode.GDMeteorObjects3);
}
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("Background"), gdjs.GameCode.GDBackgroundObjects4);
...
{for(var i = 0, len = gdjs.GameCode.GDPlatformObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDPlatformObjects4[i].setXOffset(gdjs.GameCode.GDPlatformObjects4[i].getXOffset() + (runtimeScene.getScene().getVariables().getFromIndex(3).getAsNumber() * gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene)));
}
}
{for(var i = 0, len = gdjs.GameCode.GDBackgroundObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDBackgroundObjects4[i].setXOffset(gdjs.GameCode.GDBackgroundObjects4[i].getXOffset() + (runtimeScene.getScene().getVariables().getFromIndex(3).getAsNumber() / 500 * 60 * gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene)));
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("Meteor"), gdjs.GameCode.GDMeteorObjects4);
{for(var i = 0, len = gdjs.GameCode.GDDustParticlesObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDDustParticlesObjects4[i].setEmitterForceMin(runtimeScene.getScene().getVariables().getFromIndex(3).getAsNumber() / 2);
}
}
{for(var i = 0, len = gdjs.GameCode.GDDustParticlesObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDDustParticlesObjects4[i].setEmitterForceMax(runtimeScene.getScene().getVariables().getFromIndex(3).getAsNumber() / 2 + 45);
}
}
{for(var i = 0, len = gdjs.GameCode.GDDustParticlesObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDDustParticlesObjects4[i].setFlow(100 / 1000 * runtimeScene.getScene().getVariables().getFromIndex(3).getAsNumber());
}
}
{for(var i = 0, len = gdjs.GameCode.GDDustParticlesObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDDustParticlesObjects4[i].setAngle(90 / 1000 * runtimeScene.getScene().getVariables().getFromIndex(3).getAsNumber());
}
}
{runtimeScene.getScene().getVariables().getFromIndex(12).setNumber(0.3);
}
{for(var i = 0, len = gdjs.GameCode.GDMeteorObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDMeteorObjects4[i].getBehavior("Scale").setScale(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(12)));
}
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSecondsOrNaN(runtimeScene, "meteor_spawn") >= gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(7));
if (isConditionTrue_0) {
gdjs.GameCode.GDMeteorObjects4.length = 0;

{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDMeteorObjects4Objects, gdjs.randomInRange(50, gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) - 50), -(50), "");
}
{for(var i = 0, len = gdjs.GameCode.GDMeteorObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDMeteorObjects4[i].addPolarForce(90, gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(8)), 1);
}
}
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "meteor_spawn");
}
{for(var i = 0, len = gdjs.GameCode.GDMeteorObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDMeteorObjects4[i].getBehavior("Scale").setScale(0.15);
}
}
}
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("LivesText"), gdjs.GameCode.GDLivesTextObjects4);
{runtimeScene.getScene().getVariables().getFromIndex(8).add(gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene) * 10);
}
{runtimeScene.getScene().getVariables().getFromIndex(7).sub(gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene) / 30);
}
{for(var i = 0, len = gdjs.GameCode.GDLivesTextObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDLivesTextObjects4[i].getBehavior("Text").setText("❤: " + gdjs.evtTools.common.toString(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(10))));
}
}
...
{for(var i = 0, len = gdjs.GameCode.GDScoreTextObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDScoreTextObjects3[i].getBehavior("Text").setText("Score   " + gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(0)));
}
}
...
gdjs.copyArray(runtimeScene.getObjects("broken_heart"), gdjs.GameCode.GDbroken_9595heartObjects2);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDbroken_9595heartObjects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDbroken_9595heartObjects2[i].getTimerElapsedTimeInSecondsOrNaN("desaparecer") >= 1 ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDbroken_9595heartObjects2[k] = gdjs.GameCode.GDbroken_9595heartObjects2[i];
        ++k;
    }
}
gdjs.GameCode.GDbroken_9595heartObjects2.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDbroken_9595heartObjects2 */
{for(var i = 0, len = gdjs.GameCode.GDbroken_9595heartObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDbroken_9595heartObjects2[i].deleteFromScene(runtimeScene);
}
}
}
...
gdjs.GameCode.GDCactusObstacleObjects5.length = 0;
gdjs.GameCode.GDCactusObstacleObjects6.length = 0;
gdjs.GameCode.GDCactusObstacleObjects7.length = 0;
...
gdjs.GameCode.GDIslandObstacleObjects7.length = 0;
...
gdjs.GameCode.GDScoreTextObjects7.length = 0;
...
gdjs.GameCode.GDTutorialSpriteObjects7.length = 0;
...
gdjs.GameCode.GDBonusParticleObjects7.length = 0;
...
gdjs.GameCode.GDTutorialTouchscreenJumpObjects7.length = 0;
...
gdjs.GameCode.GDTutorialTouchscreenDuckObjects7.length = 0;
...
gdjs.GameCode.GDJumpButtonObjects7.length = 0;
...
gdjs.GameCode.GDDuckButtonObjects7.length = 0;
...
gdjs.GameCode.GDLimitObjects7.length = 0;
...
gdjs.GameCode.GDDinoObjects7.length = 0;
...
gdjs.GameCode.GDPlatformObjects7.length = 0;
...
gdjs.GameCode.GDBackgroundObjects7.length = 0;
...
gdjs.GameCode.GDDustParticlesObjects7.length = 0;
gdjs.GameCode.GDMeteorObjects1.length = 0;
gdjs.GameCode.GDMeteorObjects2.length = 0;
gdjs.GameCode.GDMeteorObjects3.length = 0;
gdjs.GameCode.GDMeteorObjects4.length = 0;
gdjs.GameCode.GDMeteorObjects5.length = 0;
gdjs.GameCode.GDMeteorObjects6.length = 0;
gdjs.GameCode.GDMeteorObjects7.length = 0;
...
gdjs.GameCode.GDLivesTextObjects7.length = 0;
gdjs.GameCode.GDbroken_9595heartObjects1.length = 0;
gdjs.GameCode.GDbroken_9595heartObjects2.length = 0;
gdjs.GameCode.GDbroken_9595heartObjects3.length = 0;
gdjs.GameCode.GDbroken_9595heartObjects4.length = 0;
gdjs.GameCode.GDbroken_9595heartObjects5.length = 0;
gdjs.GameCode.GDbroken_9595heartObjects6.length = 0;
gdjs.GameCode.GDbroken_9595heartObjects7.length = 0;
...
gdjs.GameCode.GDBonusObjectObjects5.length = 0;
gdjs.GameCode.GDBonusObjectObjects6.length = 0;
gdjs.GameCode.GDBonusObjectObjects7.length = 0;

...
gdjs.GameCode.GDMeteorObjects2_1final = [];
...
gdjs.GameCode.GDNewSpriteObjects6= [];
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13105548);
}
if (isConditionTrue_0) {
...
};gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDMeteorObjects3Objects = Hashtable.newFrom({"Meteor": gdjs.GameCode.GDMeteorObjects3});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13002996);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13005012);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDDinoObjects5 */
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13005532);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13008468);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13009516);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13004004);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("DustParticles"), gdjs.GameCode.GDDustParticlesObjects4);
...
gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDCactusObstacleObjects2ObjectsGDgdjs_9546GameCode_9546GDIslandObstacleObjects2ObjectsGDgdjs_9546GameCode_9546GDBonusObjectObjects2Objects = Hashtable.newFrom({"CactusObstacle": gdjs.GameCode.GDCactusObstacleObjects2, "IslandObstacle": gdjs.GameCode.GDIslandObstacleObjects2, "BonusObject": gdjs.GameCode.GDBonusObjectObjects2});
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("BonusObject"), gdjs.GameCode.GDBonusObjectObjects2);
/* Reuse gdjs.GameCode.GDCactusObstacleObjects2 */
...
/* Reuse gdjs.GameCode.GDIslandObstacleObjects2 */
...
{for(var i = 0, len = gdjs.GameCode.GDCactusObstacleObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDCactusObstacleObjects2[i].clearForces();
}
for(var i = 0, len = gdjs.GameCode.GDIslandObstacleObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDIslandObstacleObjects2[i].clearForces();
}
for(var i = 0, len = gdjs.GameCode.GDBonusObjectObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDBonusObjectObjects2[i].clearForces();
}
}
...
{gdjs.evtTools.object.pickAllObjects(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDCactusObstacleObjects2ObjectsGDgdjs_9546GameCode_9546GDIslandObstacleObjects2ObjectsGDgdjs_9546GameCode_9546GDBonusObjectObjects2Objects);
}
...
gdjs.copyArray(gdjs.GameCode.GDMeteorObjects2, gdjs.GameCode.GDMeteorObjects3);


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDMeteorObjects3.length;i<l;++i) {
    if ( gdjs.GameCode.GDMeteorObjects3[i].getY() > gdjs.evtTools.window.getGameResolutionHeight(runtimeScene) + 100 ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDMeteorObjects3[k] = gdjs.GameCode.GDMeteorObjects3[i];
        ++k;
    }
}
gdjs.GameCode.GDMeteorObjects3.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDMeteorObjects3 */
{for(var i = 0, len = gdjs.GameCode.GDMeteorObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDMeteorObjects3[i].deleteFromScene(runtimeScene);
}
}
}
...
gdjs.GameCode.GDMeteorObjects2_1final.length = 0;
let isConditionTrue_1 = false;
isConditionTrue_0 = false;
{
...
{
gdjs.copyArray(runtimeScene.getObjects("Dino"), gdjs.GameCode.GDDinoObjects3);
gdjs.copyArray(runtimeScene.getObjects("Meteor"), gdjs.GameCode.GDMeteorObjects3);
isConditionTrue_1 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDDinoObjects3Objects, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDMeteorObjects3Objects, false, runtimeScene, false);
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
    for (let j = 0, jLen = gdjs.GameCode.GDDinoObjects3.length; j < jLen ; ++j) {
        if ( gdjs.GameCode.GDDinoObjects2_1final.indexOf(gdjs.GameCode.GDDinoObjects3[j]) === -1 )
    ...
    for (let j = 0, jLen = gdjs.GameCode.GDMeteorObjects3.length; j < jLen ; ++j) {
        if ( gdjs.GameCode.GDMeteorObjects2_1final.indexOf(gdjs.GameCode.GDMeteorObjects3[j]) === -1 )
            gdjs.GameCode.GDMeteorObjects2_1final.push(gdjs.GameCode.GDMeteorObjects3[j]);
    }
}
}
{
...
gdjs.copyArray(gdjs.GameCode.GDMeteorObjects2_1final, gdjs.GameCode.GDMeteorObjects2);
}
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.GameCode.GDMeteorObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDMeteorObjects3[i].getBehavior("Scale").setScale(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(12)));
}
}
}
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDMeteorObjects3Objects, gdjs.randomInRange(50, gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) - 50), -(50), "");
}
{for(var i = 0, len = gdjs.GameCode.GDMeteorObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDMeteorObjects3[i].addPolarForce(90, gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(8)), 1);
}
}
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "meteor_spawn");
}
{for(var i = 0, len = gdjs.GameCode.GDMeteorObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDMeteorObjects3[i].getBehavior("Scale").setScale(0.15);
}
}
}
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("LivesText"), gdjs.GameCode.GDLivesTextObjects3);
...
{for(var i = 0, len = gdjs.GameCode.GDLivesTextObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDLivesTextObjects3[i].getBehavior("Text").setText("❤: " + gdjs.evtTools.common.toString(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(10))));
}
}
...
gdjs.GameCode.GDNewSpriteObjects6.length = 0;
